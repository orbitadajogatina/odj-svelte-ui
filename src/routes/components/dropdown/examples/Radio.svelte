<script lang="ts">
  import { Button, Dropdown, DropdownUl, DropdownLi, DropdownHeader, Search, Radio, DropdownFooter } from "$lib";
...
<div class="flex h-64 items-start justify-center">
  <Button id="dropdownRadio">Dropdown radio<ChevronDownOutline class="ms-2 h-6 w-6 text-white dark:text-white" /></Button>
  <Dropdown open={dropdownRadioStatus} triggeredBy="#dropdownRadio" class="w-48 overflow-y-auto pb-3 text-sm">
    <DropdownUl>
