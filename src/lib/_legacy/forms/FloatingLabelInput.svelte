<script lang="ts">
  ...
  const labelClasses = {
    ...
    outlined: 'absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-neutral-900 px-2 peer-focus:px-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1',
  ...
  const inputColorClasses = {
    base: 'border-neutral-300 dark:border-neutral-600 dark:focus:border-primary-500 focus:border-primary-600',
