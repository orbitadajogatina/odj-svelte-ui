...
<script lang="ts">
  ...
  export let outerClass: string = 'w-full z-50 border-neutral-200 dark:bg-neutral-700 dark:border-neutral-600';
...
@prop export let outerClass: string = 'w-full z-50 border-neutral-200 dark:bg-neutral-700 dark:border-neutral-600';
