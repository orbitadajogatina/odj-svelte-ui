...
export type Colors = 'blue' | 'neutral' | 'red' | 'yellow' | 'purple' | 'green' | 'indigo' | 'pink' | 'white' | 'custom' | 'primary' | 'secondary';
...
export type IndicatorColorType = 'neutral' | 'dark' | 'blue' | 'green' | 'red' | 'purple' | 'indigo' | 'yellow' | 'teal' | 'none';
...
export type ToolbarColorType = 'neutral' | 'red' | 'yellow' | 'green' | 'indigo' | 'purple' | 'pink' | 'blue' | 'dark' | 'none';

export type ToolbarButtonType = 'dark' | 'default' | 'neutral' | 'red' | 'yellow' | 'green' | 'indigo' | 'purple' | 'pink' | 'blue';
