...
<script lang="ts">
  ...
  export let nonActiveClass: string = 'text-neutral-700 hover:bg-neutral-100 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 dark:text-neutral-400 md:dark:hover:text-white dark:hover:bg-neutral-700 dark:hover:text-white md:dark:hover:bg-transparent';
  ...
  $: _ulClass = twMerge(
    ulClass,
    // 'divide-y md:divide-y-0 divide-neutral-100 dark:divide-neutral-700',
    $$props.classUl
  );
</script>
...
@prop export let nonActiveClass: string = 'text-neutral-700 hover:bg-neutral-100 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 dark:text-neutral-400 md:dark:hover:text-white dark:hover:bg-neutral-700 dark:hover:text-white md:dark:hover:bg-transparent';
-->
