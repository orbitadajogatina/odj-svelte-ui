<script lang="ts">
  ...
  $: liClass = twMerge('block py-2 pr-4 pl-3 md:p-0 rounded-sm md:border-0', active ? activeClass ?? context.activeClass : nonActiveClass ?? context.nonActiveClass, $$props.class);
  // $: console.log()
</script>
