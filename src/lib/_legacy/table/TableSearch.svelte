<script lang="ts">
  ...
  export let svgClass: string = 'w-5 h-5 text-neutral-500 dark:text-neutral-400';
  export let inputClass: string = 'bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 p-2.5 pl-10 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500';
...
@prop export let svgClass: string = 'w-5 h-5 text-neutral-500 dark:text-neutral-400';
@prop export let inputClass: string = 'bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 p-2.5 pl-10 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500';
-->
