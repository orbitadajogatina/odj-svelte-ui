<script lang="ts">
  ...
  interface $$Props extends ComponentProps<Frame> {
    color: 'neutral' | 'red' | 'yellow' | 'green' | 'indigo' | 'purple' | 'pink' | 'blue' | 'dark' | 'none';
    embedded: boolean;
  }
  ...
  const divideColors = {
    neutral: 'divide-neutral-400 dark:divide-neutral-700',
    ...
    dark: 'divide-neutral-400 dark:divide-neutral-600',
    none: ''
  };
