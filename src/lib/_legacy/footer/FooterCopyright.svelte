<script lang="ts">
  ...
  export let spanClass: string = 'block text-sm text-neutral-500 sm:text-center dark:text-neutral-400';
...
## Props
@prop export let spanClass: string = 'block text-sm text-neutral-500 sm:text-center dark:text-neutral-400';
