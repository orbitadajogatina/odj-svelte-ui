<script lang="ts">
  ...
  export let aClass: string = 'block items-center p-3 sm:flex hover:bg-neutral-100 dark:hover:bg-neutral-700';
  export let imgClass: string = 'mr-3 mb-3 w-12 h-12 rounded-full sm:mb-0';
  export let divClass: string = 'text-neutral-600 dark:text-neutral-400';
  export let titleClass: string = 'text-base font-normal';
  export let spanClass: string = 'inline-flex items-center text-xs font-normal text-neutral-500 dark:text-neutral-400';
...
@prop export let aClass: string = 'block items-center p-3 sm:flex hover:bg-neutral-100 dark:hover:bg-neutral-700';
@prop export let imgClass: string = 'mr-3 mb-3 w-12 h-12 rounded-full sm:mb-0';
@prop export let divClass: string = 'text-neutral-600 dark:text-neutral-400';
@prop export let titleClass: string = 'text-base font-normal';
@prop export let spanClass: string = 'inline-flex items-center text-xs font-normal text-neutral-500 dark:text-neutral-400';
-->
