<script lang="ts">
  ...
  $: cardClass = twMerge('flex', sizes[size], reverse ? 'flex-col-reverse' : 'flex-col', horizontal && (reverse ? 'md:flex-row-reverse md:max-w-xl' : 'md:flex-row md:max-w-xl'), href && 'hover:bg-neutral-100 dark:hover:bg-neutral-700', !img && innerPadding, $$props.class);
