<script lang="ts">
  ...
  export let ulClass: string = 'space-y-4 text-sm text-neutral-500 dark:text-neutral-400';
  ...
  <div class="col-span-2 mt-6 md:mt-0">
    <div class="flex items-start mb-5">
      <div class="pr-4">
        ...
        {/if}
        <h4 class="text-xl font-bold text-neutral-900 dark:text-white">
          {review.title}
        </h4>
      </div>
...
@prop export let ulClass: string = 'space-y-4 text-sm text-neutral-500 dark:text-neutral-400';
