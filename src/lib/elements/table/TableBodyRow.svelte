<script lang="ts">
  ...
  const colors = {
    default: 'bg-white dark:bg-neutral-800 dark:border-neutral-700',
  ...
  const hoverColors = {
    default: 'hover:bg-neutral-50 dark:hover:bg-neutral-600',
  ...
  const stripColors = {
    default: 'odd:bg-white even:bg-neutral-50 odd:dark:bg-neutral-800 even:dark:bg-neutral-700',
