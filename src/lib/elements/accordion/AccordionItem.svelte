<script lang="ts">
  ...
  export let defaultClass: string = 'flex items-center justify-between w-full font-medium text-left group-first:rounded-t-xl border-neutral-200 dark:border-neutral-700';
  ...
  export let textFlushOpen: string = 'text-neutral-900 dark:text-white';
  export let textFlushDefault: string = 'text-neutral-500 dark:text-neutral-400';
  ...
  export let borderSharedClass: string = 'border-neutral-200 dark:border-neutral-700';
...
@prop export let defaultClass: string = 'flex items-center justify-between w-full font-medium text-left group-first:rounded-t-xl border-neutral-200 dark:border-neutral-700';
...
@prop export let textFlushOpen: string = 'text-neutral-900 dark:text-white';
@prop export let textFlushDefault: string = 'text-neutral-500 dark:text-neutral-400';
...
@prop export let borderSharedClass: string = 'border-neutral-200 dark:border-neutral-700';
